...
public class BoxSelector: NSView {
    ...
    override public func mouseDown(with event: NSEvent) {
        guard self.boxSelectorDelegate != nil else {
            NSLog("BoxSelectorDelegate not set")
            return
        }
        
        guard let boxSelectorProtocol = self.boxSelectorProtocol else {
            NSLog("BoxSelectorProtocol not set")
            return
        }
        
        guard let paletteCurrentlySelected = boxSelectorProtocol.paletteSelected else {
...
public class ColorSelector: BoxSelector, BoxSelectorProtocol {
    ...
    public func resetToOriginallySelectedItem() {
